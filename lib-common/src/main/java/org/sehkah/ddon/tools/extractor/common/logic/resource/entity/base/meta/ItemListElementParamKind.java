...
public enum ItemListElementParamKind {
    ...
    VsEm00_DEMIHUMAN_UP_ELEMENT(0x42),
    VsEm01_BEAST_UP_ELEMENT(0x43),
    VsEm02_KIZIN_UP_ELEMENT(0x44),
    VsEm03_ZOMBIE_UP_ELEMENT(0x45),
    VsEm04_SKELETON_UP_ELEMENT(0x46),
    VsEm05_WINGED_UP_ELEMENT(0x47),
    VsEm06_GIANT_UP_ELEMENT(0x48),
    VsEm07_SOFT_BODY_UP_ELEMENT(0x49),
    VsEm08_GHOST_UP_ELEMENT(0x4A),
    VsEm09_CURSE_UP_ELEMENT(0x4B),
    VsEm10_ART_EVIL_UP_ELEMENT(0x4C),
    VsEm11_HUMAN_UP_ELEMENT(0x4D),
    VsEm12_ALCHEMY_UP_ELEMENT(0x4E),
    VsEm13_DRAGON_UP_ELEMENT(0x4F),
    VsEm14_EVIL_UP_ELEMENT(0x50),
    Color_ELEMENT(0x51),
    DASH_ST_UP(0x52),
    JUMP_UP(0x53),
    CLIME_SPD_UP(0x54),
    ...
    LOW_LV_EXP_UP(0x56),
    ABILITY(0x57),
    VsEm15_EROSION_UP_ELEMENT(0x58),
    // Season 3+
    VsEm16_ARMORED_UP_ELEMENT(0x59),
    REDUCE_DASH_ST_COST_EX(0x5A),
    INCREASE_JUMP_HEIGHT_EX(0x5B),
    INCREASE_CLIMB_SPEED_EX(0x5C),
    ALL_WEIGHT_REDUCTION_EX(0x5D),
    PAWN_INSPIRATION(0x5F),
    DRAGON_ABILITY_FORCE(0x60),
    BB_JOB_PHYS_UP(0x61),
    BB_JOB_ELE_UP(0x62),
    DRAGON_ABILITY_SPIRIT(0x63),
    DRAGON_ABILITY_FIRE(0x64),
    DRAGON_ABILITY_WHITE(0x65),
    DRAGON_ABILITY_GOLDEN(0x66),
    DRAGON_ABILITY_ANTIBLACK(0x67),
