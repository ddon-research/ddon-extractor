...
import org.sehkah.ddon.tools.extractor.common.logic.resource.entity.game_common.GUIMessageIndex;
...
public class GUIMessageDeserializer extends ClientResourceFileDeserializer<GUIMessage> {
    ...
    protected GUIMessage parseClientResourceFile(Path filePath, BufferReader bufferReader, FileHeader fileHeader, ResourceMetadataLookupUtil lookupUtil) {
        ...
        return new GUIMessage(languageId, language, updateTime, indexNum, messageNum, indexNameBufferSize, bufferSize, packageName, indices, hashTable);
    }
}
