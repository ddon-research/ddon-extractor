...
class BlowFishUtilTest {
    ...
    void testDecryptResourceInfoPath() {
        ...
        FileReader temporaryReader = new BinaryFileReader(BlowFishUtil.decrypt(HexFormat.of().parseHex(sg30000ResourceInfo1)));
    ...
    void testDecryptCompatResourceInfoPath() {
        ...
        FileReader temporaryReader = new BinaryFileReader(BlowFishUtil.decryptCompat(HexFormat.of().parseHex(sg30000ResourceInfo1)));
