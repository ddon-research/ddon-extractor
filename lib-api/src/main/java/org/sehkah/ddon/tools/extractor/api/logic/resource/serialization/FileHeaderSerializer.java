...
public class FileHeaderSerializer {
    public static void writeVersion(BufferWriter bufferWriter, long versionNumber, int versionBytesLength) {
    ...
    public static void writeMagicString(BufferWriter bufferWriter, String magicString) {
        bufferWriter.writeString(magicString);
    }

    public void serializeClientResourceFile(FileHeader fileHeader, BufferWriter bufferWriter) {
