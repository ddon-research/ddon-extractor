...
import org.sehkah.ddon.tools.extractor.season3.logic.resource.entity.skill.SkillLevelData;
...
public class CustomSkillDataDeserializer extends ClientResourceFileDeserializer<CustomSkillDataList> {
    ...
    private static CustomSkillData readCustomSkillData(BufferReader bufferReader, ResourceMetadataLookupUtil lookupUtil, String gmdFilePathSkillName, String gmdFilePathSkillInfo, String gmdFilePathSkillCommand) {
        ...
        int ExSkillCustomSkillIdReference = bufferReader.readUnsignedShort();
        int ExSkillUnknownByte = bufferReader.readUnsignedByte();
        ...
        return new CustomSkillData(Id, MsgNameIndex, SkillName, SkillInfo, SkillCommand, IconId, ExSkillCustomSkillIdReference, ExSkillUnknownByte, LvArray);
    }
