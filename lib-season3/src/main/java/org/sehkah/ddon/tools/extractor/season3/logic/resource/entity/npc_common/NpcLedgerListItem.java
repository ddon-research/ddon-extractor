...
import org.sehkah.ddon.tools.extractor.season3.logic.resource.entity.npc_common.meta.NpcSexType;
import org.sehkah.ddon.tools.extractor.season3.logic.resource.entity.npc_common.meta.NpcUnitType;
import org.sehkah.ddon.tools.extractor.season3.logic.resource.entity.npc_common.meta.NpcVoiceType;
...
public class NpcLedgerListItem {
    ...
    public NpcLedgerListItem(long npcId, int sex, long nameId, long classNameId, int jobId, int finger, int voiceType,
        ...
        this(npcId,
                ...
                nameId, ResourceMetadataLookupUtilSeason3.getMessage(ResourceFileLookupType.NPC_NAME, nameId),
                classNameId, ResourceMetadataLookupUtilSeason3.getMessage(ResourceFileLookupType.NPC_CLASS_NAME, classNameId),
                jobId,
                finger,
