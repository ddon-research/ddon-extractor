...
public class LayoutGroupParamListDeserializer extends ClientResourceFileDeserializer<LayoutGroupParamList> {
    ...
    private static GroupParam readGroupParam(BufferReader bufferReader, ResourceMetadataLookupUtil lookupUtil) {
        ...
        GroupParamDeleteCondition DeleteCondition3 = readGroupParamDeleteCondition(bufferReader);
        ...
        return new GroupParam(DataCommon, LayoutIdArray, LoadCondition1, DataLotFlag, LoadCondition2, GuardData,
                LoadCondition3, LoadCondition4, LoadStageNo, Unknown1, Unknown2, Unknown3, SetCondition1, AreaHitShapeList, SetCondition2,
                SetCondition3, DeleteCondition1, DeleteCondition2, DeleteCondition3, LifeAreaArray, KillAreaType, KillAreaList);
    }
