...
import org.sehkah.ddon.tools.extractor.season2.logic.resource.deserialization.em_common.BlowSaveEmLvParamTblDeserializer;
import org.sehkah.ddon.tools.extractor.season2.logic.resource.deserialization.em_common.EmBaseInfoSvDeserializer;
import org.sehkah.ddon.tools.extractor.season2.logic.resource.deserialization.em_common.EvaluationTableDeserializer;
import org.sehkah.ddon.tools.extractor.season2.logic.resource.deserialization.em_common.OcdStatusParamResListDeserializer;
...
import org.sehkah.ddon.tools.extractor.season2.logic.resource.deserialization.marker.StageAdjoinListDeserializer;
...
public class ClientResourceFileManagerSeason2 extends ClientResourceFileManager {
    ...
    public <T extends Resource> Set<ClientResourceFile<T>> setupResourceMapping() {
        ...
        clientResourceFileSet.add((ClientResourceFile<T>) new ClientResourceFile<>(rAreaMasterSpotData, new FileHeader(7, 4), new AreaMasterSpotDataDeserializer()));
        clientResourceFileSet.add((ClientResourceFile<T>) new ClientResourceFile<>(rAreaMasterSpotDetailData, new FileHeader(4, 4), new AreaMasterSpotDetailDataDeserializer()));
        ...
        clientResourceFileSet.add((ClientResourceFile<T>) new ClientResourceFile<>(rCatchInfoParam, new FileHeader(18, 4), new CatchInfoParamTblDeserializer()));
        clientResourceFileSet.add((ClientResourceFile<T>) new ClientResourceFile<>(rCaughtInfoParam, new FileHeader(15, 4), new CaughtInfoParamTblDeserializer()));
        clientResourceFileSet.add((ClientResourceFile<T>) new ClientResourceFile<>(rCharParamEnemy, new FileHeader("cpe\0", 10, 4), new CharParamEnemyTableDeserializer()));
        ...
        clientResourceFileSet.add((ClientResourceFile<T>) new ClientResourceFile<>(rEmBaseInfoSv, new FileHeader(8, 4), new EmBaseInfoSvDeserializer()));
        ...
        clientResourceFileSet.add((ClientResourceFile<T>) new ClientResourceFile<>(rEventParam, new FileHeader(18, 4), new EventParamDeserializer()));
        ...
        clientResourceFileSet.add((ClientResourceFile<T>) new ClientResourceFile<>(rFurnitureData, new FileHeader(4, 4), new FurnitureDataDeserializer()));
        ...
        clientResourceFileSet.add((ClientResourceFile<T>) new ClientResourceFile<>(rLandInfo, new FileHeader("LAI\0", 2, 4), new LandInfoDeserializer()));
        clientResourceFileSet.add((ClientResourceFile<T>) new ClientResourceFile<>(rLayout, new FileHeader("lot\0", 117, 4), new LayoutDeserializer()));
        ...
        clientResourceFileSet.add((ClientResourceFile<T>) new ClientResourceFile<>(rOcdStatusParamRes, new FileHeader(23, 4), new OcdStatusParamResListDeserializer()));
        ...
        clientResourceFileSet.add((ClientResourceFile<T>) new ClientResourceFile<>(rOmParam, new FileHeader("TBL\0", 56, 4), new OmParamDeserializer()));
        ...
        clientResourceFileSet.add((ClientResourceFile<T>) new ClientResourceFile<>(rQuestList, new FileHeader("XFS\0", 7667727, 4), new QuestListDeserializer()));
        ...
        clientResourceFileSet.add((ClientResourceFile<T>) new ClientResourceFile<>(rRoomWearParam, new FileHeader(1, 4), new RoomWearParamTblDeserializer()));
        ...
        clientResourceFileSet.add((ClientResourceFile<T>) new ClientResourceFile<>(rStageAdjoinList, new FileHeader("SAL\0", 3, 4), new StageAdjoinListDeserializer()));
        ...
        clientResourceFileSet.add((ClientResourceFile<T>) new ClientResourceFile<>(rStageConnect, new FileHeader("scc\0", 1, 4), new StageConnectDeserializer()));
        ...
        clientResourceFileSet.add((ClientResourceFile<T>) new ClientResourceFile<>(rStageCustomParts, new FileHeader("scp\0", 17, 4), new StageCustomPartsDeserializer()));
        ...
        clientResourceFileSet.add((ClientResourceFile<T>) new ClientResourceFile<>(rStageInfo, new FileHeader("sti\0", 81, 4), new StageInfoDeserializer()));
        ...
        clientResourceFileSet.add((ClientResourceFile<T>) new ClientResourceFile<>(rTutorialList, new FileHeader("TLT\0", 5, 4), new TutorialListDeserializer()));
        ...
        clientResourceFileSet.add((ClientResourceFile<T>) new ClientResourceFile<>(rWarpLocation, new FileHeader(352, 4), new WarpLocationDeserializer()));
