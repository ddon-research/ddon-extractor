...
public class ClientResourceFileManagerSeason2 extends ClientResourceFileManager {
    ...
    public <T extends TopLevelClientResource> Set<ClientResourceFile<T>> setupResourceMapping() {
        ...
        clientResourceFileSet.add(new ClientResourceFile(rAbilityList, new FileHeader("abl0", 8, 4), new AbilityListDeserializer()));
        ...
        clientResourceFileSet.add(new ClientResourceFile(rAIPawnEmParam, new FileHeader(15, 4), new AIPawnEmParamDeserializer()));
        ...
        clientResourceFileSet.add(new ClientResourceFile(rAreaMasterSpotData, new FileHeader(7, 4), new AreaMasterSpotDataDeserializer()));
        clientResourceFileSet.add(new ClientResourceFile(rAreaMasterSpotDetailData, new FileHeader(4, 4), new AreaMasterSpotDetailDataDeserializer()));
        ...
        clientResourceFileSet.add(new ClientResourceFile(rCatchInfoParam, new FileHeader(18, 4), new CatchInfoParamTblDeserializer()));
        ...
        clientResourceFileSet.add(new ClientResourceFile(rCaughtInfoParam, new FileHeader(15, 4), new CaughtInfoParamTblDeserializer()));
        clientResourceFileSet.add(new ClientResourceFile(rCharParamEnemy, new FileHeader("cpe\0", 10, 4), new CharParamEnemyTableDeserializer()));
        ...
        clientResourceFileSet.add(new ClientResourceFile(rCustomSkillData, new FileHeader(1, 4), new CustomSkillDataDeserializer()));
        ...
        clientResourceFileSet.add(new ClientResourceFile(rEmBaseInfoSv, new FileHeader(8, 4), new EmBaseInfoSvDeserializer()));
        ...
        clientResourceFileSet.add(new ClientResourceFile(rEnemyGroup, new FileHeader(1, 4), new EnemyGroupDeserializer()));
        ...
        clientResourceFileSet.add(new ClientResourceFile(rEventParam, new FileHeader(18, 4), new EventParamDeserializer()));
        ...
        clientResourceFileSet.add(new ClientResourceFile(rFurnitureData, new FileHeader(4, 4), new FurnitureDataDeserializer()));
        ...
        clientResourceFileSet.add(new ClientResourceFile(rItemList, new FileHeader("ipa\0", 58, 4), new ItemListDeserializer()));
        ...
        clientResourceFileSet.add(new ClientResourceFile(rJumpParamTbl, new FileHeader(3, 4), new JumpParamTblDeserializer()));
        ...
        clientResourceFileSet.add(new ClientResourceFile(rLandInfo, new FileHeader("LAI\0", 2, 4), new LandInfoDeserializer()));
        clientResourceFileSet.add(new ClientResourceFile(rLayout, new FileHeader("lot\0", 117, 4), new LayoutDeserializer()));
        ...
        clientResourceFileSet.add(new ClientResourceFile(rMyRoomActParam, new FileHeader(14, 4), new MyRoomActParamTblDeserializer()));
        ...
        clientResourceFileSet.add(new ClientResourceFile(rOcdImmuneParamRes, new FileHeader(23, 4), new OcdImmuneParamResTableDeserializer()));
        clientResourceFileSet.add(new ClientResourceFile(rOcdStatusParamRes, new FileHeader(23, 4), new OcdStatusParamResListDeserializer()));
        clientResourceFileSet.add(new ClientResourceFile(rOmKey, new FileHeader("XFS\0", 15, 4), new OmKeyDeserializer()));
        clientResourceFileSet.add(new ClientResourceFile(rOmParam, new FileHeader("TBL\0", 56, 4), new OmParamDeserializer()));
        ...
        clientResourceFileSet.add(new ClientResourceFile(rPlayerExpTable, new FileHeader(2, 4), new PlayerExpTableDeserializer()));
        ...
        clientResourceFileSet.add(new ClientResourceFile(rQuestList, new FileHeader("XFS\0", 7667727, 4), new QuestListDeserializer()));
        ...
        clientResourceFileSet.add(new ClientResourceFile(rRoomWearParam, new FileHeader(1, 4), new RoomWearParamTblDeserializer()));
        ...
        clientResourceFileSet.add(new ClientResourceFile(rSituationMsgCtrl, new FileHeader("SMC\0", 2, 4), new SituationMsgCtrlDeserializer()));
        clientResourceFileSet.add(new ClientResourceFile(rStageAdjoinList, new FileHeader("SAL\0", 3, 4), new StageAdjoinListDeserializer()));
        ...
        clientResourceFileSet.add(new ClientResourceFile(rStageConnect, new FileHeader("scc\0", 1, 4), new StageConnectDeserializer()));
        clientResourceFileSet.add(new ClientResourceFile(rStageCustom, new FileHeader("sca\0", 9, 4), new StageCustomDeserializer()));
        clientResourceFileSet.add(new ClientResourceFile(rStageCustomParts, new FileHeader("scp\0", 17, 4), new StageCustomPartsDeserializer()));
        ...
        clientResourceFileSet.add(new ClientResourceFile(rStageInfo, new FileHeader("sti\0", 81, 4), new StageInfoDeserializer()));
        ...
        clientResourceFileSet.add(new ClientResourceFile(rStaminaDecTbl, new FileHeader("sdt\0", 5, 4), new StaminaDecTblDeserializer()));
        clientResourceFileSet.add(new ClientResourceFile(rStartPos, new FileHeader("XFS\0", 131087, 4), new StartPosDeserializer()));
        ...
        clientResourceFileSet.add(new ClientResourceFile(rTutorialList, new FileHeader("TLT\0", 5, 4), new TutorialListDeserializer()));
        ...
        clientResourceFileSet.add(new ClientResourceFile(rWarpLocation, new FileHeader(352, 4), new WarpLocationDeserializer()));
        ...
        clientResourceFileSet.add(new ClientResourceFile(rWeaponResTable, new FileHeader(9, 4), new WeaponResTableDeserializer()));
