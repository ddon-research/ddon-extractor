...
import org.sehkah.ddon.tools.extractor.season2.logic.resource.deserialization.season2.EM.CharParamEnemyTableDeserializer;
import org.sehkah.ddon.tools.extractor.season2.logic.resource.deserialization.season2.base.AbilityListDeserializer;
import org.sehkah.ddon.tools.extractor.season2.logic.resource.deserialization.season2.base.ItemListDeserializer;
import org.sehkah.ddon.tools.extractor.season2.logic.resource.deserialization.season2.base.LandInfoDeserializer;
import org.sehkah.ddon.tools.extractor.season2.logic.resource.deserialization.season2.base.OmParamDeserializer;
import org.sehkah.ddon.tools.extractor.season2.logic.resource.deserialization.season2.MyRoom.MyRoomActParamTblDeserializer;
import org.sehkah.ddon.tools.extractor.season2.logic.resource.deserialization.season2.MyRoom.RoomWearParamTblDeserializer;
import org.sehkah.ddon.tools.extractor.season2.logic.resource.deserialization.season2.clankyoten.FurnitureDataDeserializer;
import org.sehkah.ddon.tools.extractor.season2.logic.resource.deserialization.season2.game_common.PlayerExpTableDeserializer;
import org.sehkah.ddon.tools.extractor.season2.logic.resource.deserialization.season2.job.JumpParamTblDeserializer;
import org.sehkah.ddon.tools.extractor.season2.logic.resource.deserialization.season2.npc.SituationMsgCtrlDeserializer;
import org.sehkah.ddon.tools.extractor.season2.logic.resource.deserialization.season3.EM.*;
import org.sehkah.ddon.tools.extractor.season2.logic.resource.deserialization.season3.Human.BakeJointTblDeserializer;
import org.sehkah.ddon.tools.extractor.season2.logic.resource.deserialization.season3.Human.CatchInfoParamTblDeserializer;
import org.sehkah.ddon.tools.extractor.season2.logic.resource.deserialization.season3.Human.CaughtInfoParamTblDeserializer;
import org.sehkah.ddon.tools.extractor.season2.logic.resource.deserialization.season3.Human.WeaponOffsetTblDeserializer;
import org.sehkah.ddon.tools.extractor.season2.logic.resource.deserialization.season2.gui_cmn.WarpLocationDeserializer;
import org.sehkah.ddon.tools.extractor.season2.logic.resource.deserialization.season2.quest.AIFSMDeserializer;
import org.sehkah.ddon.tools.extractor.season2.logic.resource.deserialization.season2.quest.QuestListDeserializer;
import org.sehkah.ddon.tools.extractor.season2.logic.resource.deserialization.season2.skill.CustomSkillDataDeserializer;
import org.sehkah.ddon.tools.extractor.season2.logic.resource.deserialization.season2.stage.LayoutDeserializer;
import org.sehkah.ddon.tools.extractor.season2.logic.resource.deserialization.season2.stage.StageConnectDeserializer;
import org.sehkah.ddon.tools.extractor.season2.logic.resource.deserialization.season2.stage.StageInfoDeserializer;
import org.sehkah.ddon.tools.extractor.season2.logic.resource.deserialization.season3.MyRoom.AnimalDataDeserializer;
import org.sehkah.ddon.tools.extractor.season2.logic.resource.deserialization.season3.MyRoom.PartnerPawnTalkDeserializer;
import org.sehkah.ddon.tools.extractor.season2.logic.resource.deserialization.season3.MyRoom.PartnerReactParamTblDeserializer;
import org.sehkah.ddon.tools.extractor.season2.logic.resource.deserialization.season3.base.*;
import org.sehkah.ddon.tools.extractor.season2.logic.resource.deserialization.season3.character_edit.EditStageParamDeserializer;
import org.sehkah.ddon.tools.extractor.season2.logic.resource.deserialization.season3.clankyoten.FurnitureGroupDeserializer;
import org.sehkah.ddon.tools.extractor.season2.logic.resource.deserialization.season3.clankyoten.FurnitureItemDeserializer;
import org.sehkah.ddon.tools.extractor.season2.logic.resource.deserialization.season3.clankyoten.FurnitureLayoutDeserializer;
import org.sehkah.ddon.tools.extractor.season2.logic.resource.deserialization.season3.clankyoten.MsgSetDeserializer;
import org.sehkah.ddon.tools.extractor.season2.logic.resource.deserialization.season3.collision_common.PushRateListDeserializer;
import org.sehkah.ddon.tools.extractor.season2.logic.resource.deserialization.season3.craft_common.*;
import org.sehkah.ddon.tools.extractor.season2.logic.resource.deserialization.season3.effect_common.VfxLightInfluenceListDeserializer;
import org.sehkah.ddon.tools.extractor.season2.logic.resource.deserialization.season3.em_common.*;
import org.sehkah.ddon.tools.extractor.season2.logic.resource.deserialization.season3.equip.EquipPresetDeserializer;
import org.sehkah.ddon.tools.extractor.season2.logic.resource.deserialization.season3.fieldarea.FieldAreaAdjoinListDeserializer;
import org.sehkah.ddon.tools.extractor.season2.logic.resource.deserialization.season3.fieldarea.FieldAreaMarkerInfoDeserializer;
import org.sehkah.ddon.tools.extractor.season2.logic.resource.deserialization.season3.game_common.*;
import org.sehkah.ddon.tools.extractor.season2.logic.resource.deserialization.season3.gui_cmn.*;
import org.sehkah.ddon.tools.extractor.season2.logic.resource.deserialization.season3.job.MagicChantParamTblDeserializer;
import org.sehkah.ddon.tools.extractor.season2.logic.resource.deserialization.season3.job.MagicCommandListTblDeserializer;
import org.sehkah.ddon.tools.extractor.season2.logic.resource.deserialization.season3.job.MagicCommandWordTblDeserializer;
import org.sehkah.ddon.tools.extractor.season2.logic.resource.deserialization.season3.job.StaminaDecTblDeserializer;
import org.sehkah.ddon.tools.extractor.season2.logic.resource.deserialization.season3.launcher.ArchiveListArrayDeserializer;
import org.sehkah.ddon.tools.extractor.season2.logic.resource.deserialization.season3.marker.DungeonMarkerDeserializer;
import org.sehkah.ddon.tools.extractor.season2.logic.resource.deserialization.season3.marker.StageAdjoinList2Deserializer;
import org.sehkah.ddon.tools.extractor.season2.logic.resource.deserialization.season3.npc_common.*;
import org.sehkah.ddon.tools.extractor.season2.logic.resource.deserialization.season3.om.OmKeyDeserializer;
import org.sehkah.ddon.tools.extractor.season2.logic.resource.deserialization.season3.om.OmParamPartDeserializer;
import org.sehkah.ddon.tools.extractor.season2.logic.resource.deserialization.season3.pawn.AIPawnActNoSwitchTblDeserializer;
import org.sehkah.ddon.tools.extractor.season2.logic.resource.deserialization.season3.pawn.AISensorDeserializer;
import org.sehkah.ddon.tools.extractor.season2.logic.resource.deserialization.season3.quest.PawnQuestTalkDeserializer;
import org.sehkah.ddon.tools.extractor.season2.logic.resource.deserialization.season3.quest.QuestMarkerInfoDeserializer;
import org.sehkah.ddon.tools.extractor.season2.logic.resource.deserialization.season3.quest.QuestTextDataDeserializer;
import org.sehkah.ddon.tools.extractor.season2.logic.resource.deserialization.season3.scr.MapSpotDataDeserializer;
import org.sehkah.ddon.tools.extractor.season2.logic.resource.deserialization.season3.sg300000.ShopGoodsDeserializer;
import org.sehkah.ddon.tools.extractor.season2.logic.resource.deserialization.season3.skill.NormalSkillDataDeserializer;
import org.sehkah.ddon.tools.extractor.season2.logic.resource.deserialization.season3.stage.*;
import org.sehkah.ddon.tools.extractor.season2.logic.resource.deserialization.season3.tutorial_guide.TutorialDialogMessageDeserializer;
import org.sehkah.ddon.tools.extractor.season2.logic.resource.deserialization.season3.tutorial_guide.TutorialListDeserializer;
import org.sehkah.ddon.tools.extractor.season2.logic.resource.deserialization.season3.ui.history.QuestHistoryDataDeserializer;
import org.sehkah.ddon.tools.extractor.season2.logic.resource.deserialization.season3.ui.uGUIAreaMaster.AreaMasterRankDataDeserializer;
import org.sehkah.ddon.tools.extractor.season2.logic.resource.deserialization.season3.ui.uGUIAreaMaster.AreaMasterSpotDataDeserializer;
import org.sehkah.ddon.tools.extractor.season2.logic.resource.deserialization.season3.ui.uGUIAreaMaster.AreaMasterSpotDetailDataDeserializer;
import org.sehkah.ddon.tools.extractor.season2.logic.resource.deserialization.season3.ui.uGUIArisenCard.AchievementHeaderDeserializer;
import org.sehkah.ddon.tools.extractor.season2.logic.resource.deserialization.season3.ui.uGUIDogmaOrb.GUIDogmaOrbDeserializer;
import org.sehkah.ddon.tools.extractor.season2.logic.resource.deserialization.season3.ui.uGUIKeyConfig.KeyConfigTextTableDeserializer;
import org.sehkah.ddon.tools.extractor.season2.logic.resource.deserialization.season3.ui.uGUISkill.AbilityAddDataDeserializer;
import org.sehkah.ddon.tools.extractor.season2.logic.resource.deserialization.season3.wep_res_table.WeaponResTableDeserializer;
import org.sehkah.ddon.tools.extractor.season2.logic.resource.deserialization.season3.wep_res_table.WepCateResTblDeserializer;
...
public class ClientResourceFileManagerSeason2 extends ClientResourceFileManager {
    ...
    private static void setupClientResourceFiles(Set<ClientResourceFile> clientResourceFileSet) {
        ...
        clientResourceFileSet.add(new ClientResourceFile(rAbilityList, new FileHeader("abl0", 9, 4), org.sehkah.ddon.tools.extractor.season2.logic.resource.deserialization.season3.base.AbilityListDeserializer.class));
        ...
        clientResourceFileSet.add(new ClientResourceFile(rAreaInfo, new FileHeader("ARI\0", 2, 4), org.sehkah.ddon.tools.extractor.season2.logic.resource.deserialization.season3.base.AreaInfoDeserializer.class));
        ...
        clientResourceFileSet.add(new ClientResourceFile(rCharParamEnemy, new FileHeader("cpe\0", 11, 4), org.sehkah.ddon.tools.extractor.season2.logic.resource.deserialization.season3.EM.CharParamEnemyTableDeserializer.class));
        ...
        clientResourceFileSet.add(new ClientResourceFile(rCustomSkillData, new FileHeader(3, 4), org.sehkah.ddon.tools.extractor.season2.logic.resource.deserialization.season3.skill.CustomSkillDataDeserializer.class));
        ...
        clientResourceFileSet.add(new ClientResourceFile(rJumpParamTbl, new FileHeader(4, 4), org.sehkah.ddon.tools.extractor.season2.logic.resource.deserialization.season3.job.JumpParamTblDeserializer.class));
        ...
        clientResourceFileSet.add(new ClientResourceFile(rFurnitureData, new FileHeader(5, 4), org.sehkah.ddon.tools.extractor.season2.logic.resource.deserialization.season3.clankyoten.FurnitureDataDeserializer.class));
        ...
        clientResourceFileSet.add(new ClientResourceFile(rLandInfo, new FileHeader("LAI\0", 4, 4), org.sehkah.ddon.tools.extractor.season2.logic.resource.deserialization.season3.base.LandInfoDeserializer.class));
        clientResourceFileSet.add(new ClientResourceFile(rLayout, new FileHeader("lot\0", 138, 4), org.sehkah.ddon.tools.extractor.season2.logic.resource.deserialization.season3.stage.LayoutDeserializer.class));
        ...
        clientResourceFileSet.add(new ClientResourceFile(rMyRoomActParam, new FileHeader(15, 4), org.sehkah.ddon.tools.extractor.season2.logic.resource.deserialization.season3.MyRoom.MyRoomActParamTblDeserializer.class));
        ...
        clientResourceFileSet.add(new ClientResourceFile(rRoomWearParam, new FileHeader(2, 4), org.sehkah.ddon.tools.extractor.season2.logic.resource.deserialization.season3.MyRoom.RoomWearParamTblDeserializer.class));
        ...
        clientResourceFileSet.add(new ClientResourceFile(rSituationMsgCtrl, new FileHeader("SMC\0", 3, 4), org.sehkah.ddon.tools.extractor.season2.logic.resource.deserialization.season3.npc.SituationMsgCtrlDeserializer.class));
        clientResourceFileSet.add(new ClientResourceFile(rStageAdjoinList, new FileHeader("SAL\0", 4, 4), org.sehkah.ddon.tools.extractor.season2.logic.resource.deserialization.season3.marker.StageAdjoinListDeserializer.class));
        ...
        clientResourceFileSet.add(new ClientResourceFile(rStageConnect, new FileHeader("scc\0", 7, 4), org.sehkah.ddon.tools.extractor.season2.logic.resource.deserialization.season3.stage.StageConnectDeserializer.class));
        ...
        clientResourceFileSet.add(new ClientResourceFile(rStageInfo, new FileHeader("sti\0", 265, 4), org.sehkah.ddon.tools.extractor.season2.logic.resource.deserialization.season3.stage.StageInfoDeserializer.class));
        ...
        clientResourceFileSet.add(new ClientResourceFile(rWarpLocation, new FileHeader(353, 4), org.sehkah.ddon.tools.extractor.season2.logic.resource.deserialization.season3.gui_cmn.WarpLocationDeserializer.class));
        ...
        clientResourceFileSet.add(new ClientResourceFile(rQuestList, new FileHeader("XFS\0", 9043983, 4), org.sehkah.ddon.tools.extractor.season2.logic.resource.deserialization.season3.quest.QuestListDeserializer.class));
        ...
        clientResourceFileSet.add(new ClientResourceFile(rStageAdjoinList, new FileHeader("SAL\0", 3, 4), org.sehkah.ddon.tools.extractor.season2.logic.resource.deserialization.season2.marker.StageAdjoinListDeserializer.class));
        clientResourceFileSet.add(new ClientResourceFile(rStageConnect, new FileHeader("scc\0", 1, 4), StageConnectDeserializer.class));
        clientResourceFileSet.add(new ClientResourceFile(rStageCustomParts, new FileHeader("scp\0", 17, 4), org.sehkah.ddon.tools.extractor.season2.logic.resource.deserialization.season2.stage.StageCustomPartsDeserializer.class));
        ...
        clientResourceFileSet.add(new ClientResourceFile(rTutorialList, new FileHeader("TLT\0", 5, 4), org.sehkah.ddon.tools.extractor.season2.logic.resource.deserialization.season2.tutorial_guide.TutorialListDeserializer.class));
        ...
        clientResourceFileSet.add(new ClientResourceFile(rAreaInfo, new FileHeader("ARI\0", 1, 4), AreaInfoDeserializer.class));
    }
}
