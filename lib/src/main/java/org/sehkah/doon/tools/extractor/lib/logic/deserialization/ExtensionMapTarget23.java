...
public enum ExtensionMapTarget23 {
    ...
    rBrowserFont("bft", "bft\0", 0, null), // v2.3 only
    ...
    ExtensionMapTarget23(String fileExtension, String magic, long version, Class<? extends Deserializer> deserializer) {
