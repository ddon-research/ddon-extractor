...
public enum ExtensionMapTarget {
    ...
    rAreaInfo("ari", "ari\0", 0, null),
    rAreaInfoJointArea("arj", "arj\0", 0, null),
    rAreaInfoStage("ars", "ars\0", 0, null),
    ...
    rFieldAreaList("fal", "fal\0", 0, null),
    rFieldAreaMarkerInfo("fmi", "fmi\0", 0, null),
    ...
    rJobBaseParam("jobbase", "jobbase\0", 0, null),
    rJobCustomParam("jcp", "jcp\0", 0, null),
    rJobLevelUpTbl2("jlt2", "jlt2\0", 0, null),
    rJobMasterCtrl("jmc", "jmc\0", 0, null),
    rJobTutorialQuestList("jtq", "jtq\0", 0, null),
    ...
    rQuestSequenceList("qsq", "qsq\0", 0, null),
    ...
    rShopGoods("spg_tbl", "spg_tbl\0", 0, null),
    ...
    rStageList("slt", "slt\0", 0, null),
    rStageMap("smp", "smp\0", 0, null),
    rStageToSpot("sts", "sts\0", 0, null),
    ...
    rStatusGainTable("sg_tbl", "sg_tbl\0", 0, null),
    ...
    rTutorialQuestGroup("tqg", "tqg\0", 0, null),
    ...
    rWarpLocation("wal", "wal\0", 0, null),
