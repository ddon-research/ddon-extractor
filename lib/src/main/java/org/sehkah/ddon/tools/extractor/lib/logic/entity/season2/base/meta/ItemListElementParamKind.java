...
public enum ItemListElementParamKind {
    ...
    public static ItemListElementParamKind of(long value) {
        return Arrays.stream(ItemListElementParamKind.values()).filter(itemListElementParamKind -> itemListElementParamKind.value == value).findFirst().orElse(ELEMENT_PARAM_KIND_UNKNOWN);
    }
}
