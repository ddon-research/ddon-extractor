...
public class ClientResourceFileManagerSeason1 extends ClientResourceFileManager {
    ...
    private static void setupClientResourceFiles(Set<ClientResourceFile> clientResourceFileSet) {
        ...
        // TODO: clientResourceFileSet.add(new ClientResourceFile(rAIPawnAutoWordTbl, new FileHeader(3, 4), AIPawnAutoWordTblDeserializer.class));
        // TODO: clientResourceFileSet.add(new ClientResourceFile(rAIPawnEmParam, new FileHeader(12, 4), AIPawnEmParamDeserializer.class));
        // TODO: clientResourceFileSet.add(new ClientResourceFile(rAIPawnOrder, new FileHeader(13, 4), AIPawnOrderDeserializer.class));
        ...
        clientResourceFileSet.add(new ClientResourceFile(rAreaMasterRankData, new FileHeader(2, 4), AreaMasterRankDataDeserializer.class));
        // TODO: clientResourceFileSet.add(new ClientResourceFile(rAreaMasterSpotData, new FileHeader(6, 4), AreaMasterSpotDataDeserializer.class));
        // TODO: clientResourceFileSet.add(new ClientResourceFile(rAreaMasterSpotDetailData, new FileHeader(3, 4), AreaMasterSpotDetailDataDeserializer.class));
        ...
        clientResourceFileSet.add(new ClientResourceFile(rCatchInfoParam, new FileHeader(17, 4), CatchInfoParamTblDeserializer.class));
        ...
        clientResourceFileSet.add(new ClientResourceFile(rCaughtInfoParam, new FileHeader(13, 4), CaughtInfoParamTblDeserializer.class));
        // TODO: clientResourceFileSet.add(new ClientResourceFile(rCharParamEnemy, new FileHeader("cpe\0", 3, 4), CharParamEnemyTableDeserializer.class));
        // TODO: clientResourceFileSet.add(new ClientResourceFile(rChildRegionStatusParam, new FileHeader(50, 4), ChildRegionStatusParamDeserializer.class));
        // TODO: clientResourceFileSet.add(new ClientResourceFile(rChildRegionStatusParamList, new FileHeader(50, 4), ChildRegionStatusParamListTableDeserializer.class));
        ...
        clientResourceFileSet.add(new ClientResourceFile(rEmBaseInfoSv, new FileHeader(3, 4), EmBaseInfoSvDeserializer.class));
        ...
        clientResourceFileSet.add(new ClientResourceFile(rEmLvUpParam, new FileHeader(6, 4), EmLvUpParamDeserializer.class));
        ...
        clientResourceFileSet.add(new ClientResourceFile(rEmWorkRateTable, new FileHeader(257, 4), EmWorkRateTableDeserializer.class));
        ...
        // TODO: clientResourceFileSet.add(new ClientResourceFile(rEventParam, new FileHeader(9, 4), EventParamDeserializer.class));
        // TODO: clientResourceFileSet.add(new ClientResourceFile(rFieldMapData, new FileHeader("fmd\0", 9, 4), FieldMapDataDeserializer.class));
        ...
        // TODO: clientResourceFileSet.add(new ClientResourceFile(rItemList, new FileHeader("ipa\0", 47, 4), ItemListDeserializer.class));
        // TODO: clientResourceFileSet.add(new ClientResourceFile(rJobBaseParam, new FileHeader(262, 4), JobBaseParamDeserializer.class));
        ...
        // TODO: clientResourceFileSet.add(new ClientResourceFile(rJumpParamTbl, new FileHeader(1, 4), JumpParamTblDeserializer.class));
        // TODO: clientResourceFileSet.add(new ClientResourceFile(rLayout, new FileHeader("lot\0", 82, 4), LayoutDeserializer.class));
        clientResourceFileSet.add(new ClientResourceFile(rLayoutPreset, new FileHeader(5, 4), LayoutPresetDeserializer.class));
        // TODO: clientResourceFileSet.add(new ClientResourceFile(rLocationData, new FileHeader("lcd\0", 5, 4), LocationDataDeserializer.class));
        ...
        clientResourceFileSet.add(new ClientResourceFile(rNpcLedgerList, new FileHeader("nll\0", 4, 4), NpcLedgerListDeserializer.class));
        ...
        clientResourceFileSet.add(new ClientResourceFile(rOcdImmuneParamRes, new FileHeader(18, 4), OcdImmuneParamResTableDeserializer.class));
        clientResourceFileSet.add(new ClientResourceFile(rOcdStatusParamRes, new FileHeader(18, 4), OcdStatusParamResListDeserializer.class));
        // TODO: clientResourceFileSet.add(new ClientResourceFile(rOmParam, new FileHeader("TBL\0", 54, 4), OmParamDeserializer.class));
        // TODO: clientResourceFileSet.add(new ClientResourceFile(rParentRegionStatusParam, new FileHeader(50, 4), ParentRegionStatusParamTableDeserializer.class));
        ...
        clientResourceFileSet.add(new ClientResourceFile(rQuestList, new FileHeader("XFS\0", 5457496, 4), QuestListDeserializer.class));
        ...
        // TODO: clientResourceFileSet.add(new ClientResourceFile(rStageCustom, new FileHeader("sca\0", 7, 4), StageCustomDeserializer.class));
        // TODO: clientResourceFileSet.add(new ClientResourceFile(rStageInfo, new FileHeader("sti\0", 74, 4), StageInfoDeserializer.class));
        // TODO: clientResourceFileSet.add(new ClientResourceFile(rStageJoint, new FileHeader("sja\0", 13, 4), StageJointDeserializer.class));
        // TODO: clientResourceFileSet.add(new ClientResourceFile(rStageList, new FileHeader("slt\0", 26, 4), StageListDeserializer.class));
        ...
        clientResourceFileSet.add(new ClientResourceFile(rTutorialList, new FileHeader("TLT\0", 3, 4), TutorialListDeserializer.class));
        ...
        // TODO: clientResourceFileSet.add(new ClientResourceFile(rWarpLocation, new FileHeader(304, 4), WarpLocationDeserializer.class));
        ...
        clientResourceFileSet.add(new ClientResourceFile(rAreaInfo, new FileHeader("ARI\0", 1, 4), org.sehkah.ddon.tools.extractor.season1.logic.resource.deserialization.game_common.AreaInfoDeserializer.class));
        clientResourceFileSet.add(new ClientResourceFile(rStageAdjoinList, new FileHeader("SAL\0", 2, 4), StageAdjoinListDeserializer.class));
        clientResourceFileSet.add(new ClientResourceFile(rStageCustomParts, new FileHeader("scp\0", 16, 4), StageCustomPartsDeserializer.class));
