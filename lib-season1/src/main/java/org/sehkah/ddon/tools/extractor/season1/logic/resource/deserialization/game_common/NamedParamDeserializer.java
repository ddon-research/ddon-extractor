...
import org.sehkah.ddon.tools.extractor.season1.logic.resource.entity.game_common.NamedParam;
import org.sehkah.ddon.tools.extractor.season1.logic.resource.entity.game_common.NamedParamList;
...
public class NamedParamDeserializer extends ClientResourceFileDeserializer<NamedParamList> {
    private static NamedParam readNamedParam(BufferReader bufferReader, ResourceMetadataLookupUtil lookupUtil) {
        ...
        String Name = null;
        if (lookupUtil != null) {
            Name = lookupUtil.getMessage(ResourceFileLookupType.NAMED_PARAM.getFilePath(), "namedparam_" + ID);
        }
